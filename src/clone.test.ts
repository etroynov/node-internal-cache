...
describe('clone function', () => {
	...
	it('should clone functions by reference', () => {
		const fn = () => 'hello';
	...
	it('should clone non-enumerable properties when includeNonEnumerable is true', () => {
		const obj = { a: 1 };
	...
	it('should not clone non-enumerable properties when includeNonEnumerable is false', () => {
		const obj = { a: 1 };
		Object.defineProperty(obj, 'hidden', {
			value: 42,
			enumerable: false,
	...
	it('clone.clonePrototype should create a shallow clone using the prototype', () => {
